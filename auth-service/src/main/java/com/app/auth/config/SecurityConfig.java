    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // FIX: Permit CORS preflight requests explicitly — OPTIONS must be allowed
                // before Spring Security can evaluate any other rules, otherwise
                // browser preflights get rejected with 403.
