...
public interface QuantityMeasurementRepository
    ...
    /** All records belonging to a specific user. */
    List<QuantityMeasurementEntity> findByUserEmail(String userEmail);

    /** A specific user's records filtered by operation type. */
    List<QuantityMeasurementEntity> findByUserEmailAndOperation(String userEmail, String operation);

    /** A specific user's records filtered by measurement type of the first operand. */
    List<QuantityMeasurementEntity> findByUserEmailAndThisMeasurementType(String userEmail, String measurementType);

    /** A specific user's error records. */
    List<QuantityMeasurementEntity> findByUserEmailAndErrorTrue(String userEmail);

    /** Count of successful operations for a specific user and operation type. */
