...
public class QuantityMeasurementEntity implements Serializable {
    ...
    /**
     * Email of the authenticated user who triggered the operation.
     * {@code null} for anonymous (unauthenticated) public operations.
     * Populated from the {@code X-Auth-User-Email} header set by the gateway.
     */
